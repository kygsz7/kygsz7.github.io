/* eslint-disable @typescript-eslint/no-explicit-any --
   Three.js CDN'den runtime'da yukleniyor (asagidaki script tag'i), bu yuzden
   statik tipi yok. Tiplemek icin: npm i -D @types/three ve
   `import type * as THREE from 'three'` (type-only import bundle'a girmez). */
"use client";
