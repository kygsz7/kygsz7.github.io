...
/* Site kalici koyu temada — "dark:" varyantlari hic devreye girmiyordu,
...
export default function SocialCards({ cards, ambient = false }: SocialCardsProps) {
  ...
  useEffect(() => {
    ...
    // Hareket azaltma tercihi: animasyonlari atla, kartlari dogrudan yerine koy.
    ...
    cardElements.forEach((card, cardIndex) => {
      ...
      if (slot !== undefined) {
        ...
        gsap.to(card, { x: `${exitX}rem`, opacity: 0, scale: 0.5, rotation: direction === "right" ? -30 : 30, duration: reduced ? 0 : 0.4, ease: "power2.in", zIndex: 0 });
      } else if (isFirstMount) {
